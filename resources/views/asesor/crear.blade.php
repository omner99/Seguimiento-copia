...
<div class="horizontal" style="margin-top:20px;"><p class="subtitulo">Registrar un Asesor Interno</p></div>

<div class="centro"; style="margin-top: 60px; ">
    <form action="{{route("asesores.store")}}" method="POST" enctype="application/x-www-form-urlencoded" >
        @csrf
